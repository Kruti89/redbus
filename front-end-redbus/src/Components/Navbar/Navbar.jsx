    ...
    <div className={styles.Navbar}>
      ...
      <div className={styles.leftSide_header}>
        ...
        <ul className={styles.Navbar__listOne}>
          ...
          <li>
            <Link to="/rpool">BUS TICKETS</Link>
          </li>
          <li>
        ...
        <div className={styles.rightSide_header}>
          ...
          <li>
            <div>
              ...
              >
                <MenuItem onClick={() => handleMenuSelect("/manage-booking/bus-ticket")}>Bus Ticket</MenuItem>
                <MenuItem onClick={() => handleMenuSelect("/manage-booking/cancel")}>Cancel</MenuItem>
                <MenuItem onClick={() => handleMenuSelect("/manage-booking/reschedule")}>Reschedule</MenuItem>
                <MenuItem onClick={() => handleMenuSelect("/manage-booking/show-ticket")}>Show My Ticket</MenuItem>
                <MenuItem onClick={() => handleMenuSelect("/manage-booking/email-sms")}>Email / SMS</MenuItem>
              </Menu>
            </div>
          </li>
          <li>
