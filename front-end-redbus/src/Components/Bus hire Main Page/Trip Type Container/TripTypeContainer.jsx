      ...
      <div className={Styles.tripTypecontainer}>
        ...
        >
          ...
          <div className={Styles.journeyTypeDiv} onClick={checkLogin}>
            ...
            <div>
              <img
                src="https://img.icons8.com/external-filled-outline-dual-tone/96/000000/external-outstation-travel-filled-outline-dual-tone.png"
                alt="Outstation"
                height="90px"
              />
            </div>
          ...
          >
            ...
            <div>
              <img
                src="https://img.icons8.com/external-wanicon-lineal-color-wanicon/96/000000/external-city-travel-wanicon-lineal-color-wanicon.png"
                alt="Local"
                height="90px"
              />
            </div>
          ...
          >
            ...
            <div>
              <img
                src="https://img.icons8.com/color/96/000000/airport.png"
                alt="Airport"
                height="90px"
              />
            </div>
